        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div className='mt-10 flex gap-4'>
                {isEdit
                    ? (
                        <>
                            <button onClick={updateUserProfileData} className='border border-primary px-8 py-2 rounded-full bg-primary text-white hover:bg-primary-dark transition-all'>Save information</button>
                            <button onClick={cancelEdit} className='border border-gray-400 px-8 py-2 rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300 transition-all'>Cancel</button>
                        </>
                    )
