...
const Appointment = () => {
    ...
    return docInfo ? (
        <div>
            ...
            {/* Booking slots */}
            <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]' data-aos="fade-up">
                <p>Booking slots</p>
                    ...
                    {docSlots.length &&
                        docSlots.map((item, index) => (
                            <div
                                ...
                                key={index}
                                className={`text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex === index ? 'bg-teal-500 text-white' : 'border border-[#DDDDDD]'}`}
                                data-aos="zoom-in"
                            >
                ...
                <button
                    ...
                    className='bg-teal-500 text-white text-sm font-light px-20 py-3 rounded-full my-6'
                    data-aos="fade-up"
                    data-aos-delay="200"
                >
                    Book an appointment
