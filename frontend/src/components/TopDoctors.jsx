...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
            ...
            <p className='sm:w-1/3 text-center text-sm sm:text-base md:text-lg'>
            ...
            <button
                ...
                className='bg-[#EAEFFF] text-gray-600 px-12 py-3 rounded-full mt-10 hover:bg-cyan-500 hover:text-white transition-all duration-500'
            >
                more
            </button>
        </div>
